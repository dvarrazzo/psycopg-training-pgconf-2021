"""Demo of a push application from PostgreSQL to WebSocket

Run this script (with a dsn as arg), connect to http://localhost:7000/.

In a psql window connect to the same database and run::
...
def listen_db():
    """Listen for database notifications and push them in the client queues."""
